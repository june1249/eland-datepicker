angular.module('eland-datepicker.provider', [])

  .provider('elandDatePicker', function () {
    ...
    this.$get = ['$rootScope', '$ionicPopup', '$ionicModal', 'ElandDatepickerService', function ($rootScope, $ionicPopup, $ionicModal, ElandDatepickerService) {
      ...
      function refreshDateList(currentDate) {
        ...
        if ($scope.mainObj.monthsList && $scope.mainObj.monthsList.length === 12) {
          ...
          $scope.monthsList = ElandDatepickerService.monthsList;
        }

        $scope.yearsList = ElandDatepickerService.getYearsList($scope.mainObj.from, $scope.mainObj.to);
      ...
      $ionicModal.fromTemplateUrl('eland-datepicker-modal.html', {
        scope: $scope,
      ...
      provider.openDatePicker = function (ipObj) {
        ...
        console.log('$scope.mainObj.buttonSetRight: ' + $scope.mainObj.buttonSetRight);
        ...
        if($scope.mainObj.buttonSetRight) {
          if(buttons.length == 2) {
        ...
        if($scope.mainObj.colorTheme == 'positive') $scope.cssClass = 'eland_datepicker_popup';
        else if($scope.mainObj.colorTheme == 'calm') $scope.cssClass = 'eland_datepicker_calm_popup';
        else if($scope.mainObj.colorTheme == 'balanced') $scope.cssClass = 'eland_datepicker_balanced_popup';
        else if($scope.mainObj.colorTheme == 'energized') $scope.cssClass = 'eland_datepicker_energized_popup';
        else if($scope.mainObj.colorTheme == 'assertive') $scope.cssClass = 'eland_datepicker_assertive_popup';
        else if($scope.mainObj.colorTheme == 'royal') $scope.cssClass = 'eland_datepicker_royal_popup';
        else if($scope.mainObj.colorTheme == 'dark') $scope.cssClass = 'eland_datepicker_dark_popup';
        else if($scope.mainObj.colorTheme == 'eland') $scope.cssClass = 'eland_datepicker_eland_popup';

        if ($scope.mainObj.templateType.toLowerCase() == 'popup') {
          $scope.popup = $ionicPopup.show({
            templateUrl: 'eland-datepicker-popup.html',
            scope: $scope,
